...
function pageLoad(series_type, swap) {
	...
	// -------------INDICATORS SECTION ------------------
		...
		var regressionData = new Array(); // this holds the lrData/raffData objects for the doRegression call
		...
		var ema9 = exp_ma(parseFloat(emaPeriod), parseFloat(emaSmooth));
